this.defend_jin_action <- this.inherit("scripts/factions/faction_action", {
	m = {
		Settlement = null
	},
	function create()
	{
		this.m.ID = "defend_jin_action";
	...
	function onExecute( _faction )
	{
		...
		{
			local party = this.getFaction().spawnEntity(spawnpoints[i], "Jurchen", false, this.Const.World.Spawn.JurchenDefenders, this.m.Settlement.getResources() * 0.66);
