this.jinweapon19_01 <- this.inherit("scripts/skills/skill", {
	m = {},
	function create()
	{
		this.m.ID = "actives.jinweapon19_01";
		this.m.Name = "Poking";
		this.m.Description = "A sting made with a halberd.";
		this.m.KilledString = "Impaled";
		this.m.Icon = "skills/jinweapon19_01.png";
		this.m.IconDisabled = "skills/jinweapon19_01_sw.png";
		this.m.Overlay = "jinweapon19_01";
		this.m.SoundOnUse = [
