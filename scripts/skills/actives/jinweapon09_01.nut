this.jinweapon09_01 <- this.inherit("scripts/skills/skill", {
	m = {
		SoundsA = [
	...
	function create()
	{
		this.m.ID = "actives.jinweapon09_01";
		this.m.Name = "Cleave";
		...
		this.m.Icon = "skills/jinweapon09_01.png";
		this.m.IconDisabled = "skills/jinweapon09_01_sw.png";
		this.m.Overlay = "jinweapon09_01";
		this.m.SoundOnUse = [
