this.jinweapon11_01 <- this.inherit("scripts/skills/skill", {
	m = {},
	function create()
	{
		this.m.ID = "actives.jinweapon11_01";
		this.m.Name = "Thump";
		this.m.Description = "The fierce blow of the mace can make the enemy bloody.";
		this.m.KilledString = "Cudgeled to death";
		this.m.Icon = "skills/jinweapon11_01.png";
		this.m.IconDisabled = "skills/jinweapon11_01_sw.png";
		this.m.Overlay = "jinweapon11_01";
		this.m.SoundOnUse = [
