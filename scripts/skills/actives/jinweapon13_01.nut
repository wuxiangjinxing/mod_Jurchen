this.jinweapon13_01 <- this.inherit("scripts/skills/skill", {
	m = {
		SoundsA = [
	...
	function create()
	{
		this.m.ID = "actives.jinweapon13_01";
		this.m.Name = "Devastating Blow";
		this.m.Description = "Strike the enemy heavily, and the enemy hit by this kind of attack will appear dizzy, bleeding and other abnormal states.";
		this.m.KilledString = "Cudgeled to death";
		this.m.Icon = "skills/jinweapon13_01.png";
		this.m.IconDisabled = "skills/jinweapon13_01_sw.png";
		this.m.Overlay = "jinweapon13_01";
		this.m.SoundOnUse = [
