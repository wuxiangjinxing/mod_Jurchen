this.jinweapon02_01 <- this.inherit("scripts/skills/skill", {
	m = {},
	function create()
	{
		this.m.ID = "actives.jinweapon02_01";
		this.m.Name = "Poking";
		this.m.Description = "A sting made with a halberd.";
		this.m.KilledString = "Impaled";
		this.m.Icon = "skills/jinweapon02_01.png";
		this.m.IconDisabled = "skills/jinweapon02_01_sw.png";
		this.m.Overlay = "jinweapon02_01";
		this.m.SoundOnUse = [
