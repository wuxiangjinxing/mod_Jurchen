this.jinweapon08_01 <- this.inherit("scripts/skills/skill", {
	m = {
		SoundsA = [
	...
	function create()
	{
		this.m.ID = "actives.jinweapon08_01";
		this.m.Name = "Cleave";
		...
		this.m.Icon = "skills/jinweapon08_01.png";
		this.m.IconDisabled = "skills/jinweapon08_01_sw.png";
		this.m.Overlay = "jinweapon08_01";
		this.m.SoundOnUse = [
