this.jinweapon06_01 <- this.inherit("scripts/skills/skill", {
	m = {
		SoundsA = [
	...
	function create()
	{
		this.m.ID = "actives.jinweapon06_01";
		this.m.Name = "Cleave";
		...
		this.m.Icon = "skills/jinweapon06_01.png";
		this.m.IconDisabled = "skills/jinweapon06_01_sw.png";
		this.m.Overlay = "jinweapon06_01";
		this.m.SoundOnUse = [
