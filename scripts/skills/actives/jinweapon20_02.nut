this.jinweapon20_02 <- this.inherit("scripts/skills/skill", {
	m = {},
	function create()
	{
		this.m.ID = "actives.jinweapon20_02";
		this.m.Name = "Total annihilation";
		this.m.Description = "A savage sweep with a heavy halberd.";
		this.m.Icon = "skills/jinweapon20_02.png";
		this.m.IconDisabled = "skills/jinweapon20_02_sw.png";
		this.m.Overlay = "jinweapon20_02";
		this.m.SoundOnUse = [
