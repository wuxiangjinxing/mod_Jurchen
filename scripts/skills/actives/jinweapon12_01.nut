this.jinweapon12_01 <- this.inherit("scripts/skills/skill", {
	m = {
		ApplyBonusToBodyPart = -1
	},
	function create()
	{
		this.m.ID = "actives.jinweapon12_01";
		...
		this.m.Icon = "skills/jinweapon12_01.png";
		this.m.IconDisabled = "skills/jinweapon12_01_sw.png";
		this.m.Overlay = "jinweapon12_01";
		this.m.SoundOnUse = [
