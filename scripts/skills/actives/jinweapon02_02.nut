this.jinweapon02_02 <- this.inherit("scripts/skills/skill", {
	m = {},
	function create()
	{
		this.m.ID = "actives.jinweapon02_02";
		this.m.Name = "Sweeping";
		this.m.Description = "Use halberd for powerful sweeping attack with huge range.";
		this.m.Icon = "skills/jinweapon02_02.png";
		this.m.IconDisabled = "skills/jinweapon02_02_sw.png";
		this.m.Overlay = "jinweapon02_02";
		this.m.SoundOnUse = [
