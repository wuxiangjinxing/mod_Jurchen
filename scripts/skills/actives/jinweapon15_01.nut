this.jinweapon15_01 <- this.inherit("scripts/skills/skill", {
	m = {},
	function create()
	{
		this.m.ID = "actives.jinweapon15_01";
		this.m.Name = "Impale";
		...
		this.m.Icon = "skills/jinweapon15_01.png";
		this.m.IconDisabled = "skills/jinweapon15_01_sw.png";
		this.m.Overlay = "jinweapon15_01";
		this.m.SoundOnUse = [
