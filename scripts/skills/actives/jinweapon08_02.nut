this.jinweapon08_02 <- this.inherit("scripts/skills/skill", {
	m = {},
	function create()
	{
		this.m.ID = "actives.jinweapon08_02";
		this.m.Name = "Chop";
		this.m.Description = "Use a big knife to chop, you can hit multiple enemies at one time.";
		this.m.KilledString = "Split in two";
		this.m.Icon = "skills/jinweapon08_02.png";
		this.m.IconDisabled = "skills/jinweapon08_02_sw.png";
		this.m.Overlay = "jinweapon08_02";
		this.m.SoundOnUse = [
