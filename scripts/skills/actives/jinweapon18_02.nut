this.jinweapon18_02 <- this.inherit("scripts/skills/skill", {
	m = {},
	function create()
	{
		this.m.ID = "actives.jinweapon18_02";
		this.m.Name = "Total Annihilation";
		this.m.Description = "A savage sweep with a heavy halberd.";
		this.m.Icon = "skills/jinweapon18_02.png";
		this.m.IconDisabled = "skills/jinweapon18_02_sw.png";
		this.m.Overlay = "jinweapon18_02";
		this.m.SoundOnUse = [
