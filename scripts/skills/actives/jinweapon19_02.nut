this.jinweapon19_02 <- this.inherit("scripts/skills/skill", {
	m = {},
	function create()
	{
		this.m.ID = "actives.jinweapon19_02";
		this.m.Name = "The Piercing";
		this.m.Description = "Use a cross pike to deliver a vicious piercing attack that hits both foes in front of you and those behind you.";
