this.jinweapon12_02 <- this.inherit("scripts/skills/skill", {
	m = {},
	function create()
	{
		this.m.ID = "actives.jinweapon12_02";
		this.m.Name = "Devastation";
		this.m.Description = "Use brute force to sweep the enemies around. You can't use it without enough force.";
